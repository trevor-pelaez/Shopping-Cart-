...
class PartTest {
    ...
    void setInvMin() {
        int invMin=1;
        partIn.setId(invMin);
        assertEquals(partIn.getMinInv(), invMin);
        partOut.setId(invMin);
        assertEquals(partOut.getMinInv(), invMin);
    }
    ...
    void setInvMax() {
        int invMax=1;
        partIn.setId(invMax);
        assertEquals(partIn.getMaxInv(), invMax);
        partOut.setId(invMax);
        assertEquals(partOut.getMaxInv(), invMax);
    }
